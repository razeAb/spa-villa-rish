...
const COPY = {
  he: {
    ...
    bullets: [
      ...
      "עיסוי של 30 דקות לכל אחד על השיש בחמאם",
      "גישה חופשית לסאונה ולג'קוזי",
      "פינת קפה ועוגה",
      "חוויה אותנטית של חמאם מסורתי",
    ],
  ...
  en: {
    ...
    bullets: [
      ...
      "30-minute massage for each person on the marble slab",
      "Free access to the sauna & jacuzzi",
      "Coffee & cake corner",
      "Authentic experience of a traditional hammam",
    ],
...
export default function TurkishHammamPackage() {
  ...
  return (
    <motion.section
      ...
      style={{ backgroundImage: "url('/photos/turkishHamam.jpg')", scrollMarginTop: "120px" }} // replace with your image
    >
      {/* Overlays */}
      ...
      <div className="relative z-10 mx-auto flex min-h-[100dvh] w-full max-w-[1100px] items-center px-6 py-24 md:px-10">
        ...
        >
          ...
          <Link
            to={{ pathname: "/booking", search: `?serviceSlug=${encodeURIComponent(HAMMAM_SLUG)}` }}
            state={{ serviceSlug: HAMMAM_SLUG }}
